...
function CountUpNumber({ value, isVisible }: { value: string; isVisible: boolean }) {
...
export function AboutSection() {
  ...
  return (
    <section id="about" ref={sectionRef} className="py-32 bg-background overflow-hidden">
          ...
          >
            ...
            <div className="mt-8 space-y-6 text-muted-foreground leading-relaxed">
              <p>
                ...
                creating digital products that matter. Our approach combines creative
                excellence with technical precision.
              </p>
              <p>
                From startups to Fortune 500 companies, we partner with ambitious teams
                to build products that users love and businesses depend on.
              </p>
            </div>

            {/* Values */}
            <div className="mt-12 flex flex-wrap gap-3">
              {["Innovation", "Quality", "Collaboration", "Transparency"].map((value) => (
                <span
                  key={value}
          ...
          <div className="flex animate-marquee">
            {[...Array(2)].map((_, i) => (
              <div key={i} className="flex shrink-0">
                {["React", "Next.js", "TypeScript", "Tailwind", "Framer Motion", "Vercel", "Figma", "Node.js"].map((tech) => (
                  <span
                    key={`${tech}-${i}`}
